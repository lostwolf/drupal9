<div id="gavias_customize_form" class="gavias_customize_form">
   ...
   <div class="form-group action">
      ...
      <input type="hidden" id="gva_theme_name" name="theme_name" value="gavias_nonid" />
   </div>   
         ...
         <div class="card">
            ...
            <div id="customize-typo" class="collapse show" data-parent="#customize-accordion">
               <div class="card-body">
                  ...
                  <div class="form-wrapper">
                     <div class="form-group">
                        <label>Heading Font (H1, H2, H3, H4, H5, H6)</label>
                        <div class="input-group">
         ...
         <div class="card">
            ...
            <div id="customize-body" class="collapse" data-parent="#customize-accordion">
               <div class="card-body">
                  ...
                  <div class="form-wrapper">
                  <div class="desc" style="line-height: 16px;"><b>You can upload image for /themes/gavias_nonid/images/patterns</b></div>
                     <div class="form-group">
