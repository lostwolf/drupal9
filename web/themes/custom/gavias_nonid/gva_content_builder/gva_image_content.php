      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <?php if($skin == 'skin-v1'){ ?>
            <div class="gsc-image-content clearfix <?php print $el_class; ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="box-image"><?php if($link){ ?><a <?php print $target ?> href="<?php print $link ?>"><?php } ?><img src="<?php print $background ?>" alt="<?php print strip_tags($title) ?>" /><?php if($link){ ?></a><?php } ?></div>
         ...
         <?php if($skin == 'skin-v2'){ ?>
            <div class="gsc-image-content <?php print $el_class; ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               ...
               <div class="box-content">
                  ...
                  <div class="desc"><?php print $content; ?></div>
                  <?php if($link){ ?>
                     <div class="box-action"><a <?php print $target ?> href="<?php print $link ?>"><?php print t('Read more') ?></a></div>
                  <?php } ?>
               </div>  
            </div>
         <?php } ?> 
