		...
		return array(
         ...
         'key'    => 'gva_column',
          ...
          array(
             ...
             'options'    => array(
             ''                 => 'Default',
               'column-style-1'        => 'Style 1: Fixable width of column left when row-fullwidth',
               'column-style-2'        => 'Style 2: Fixable width of column right when row-fullwidth',
               'column-style-3'        => 'Style 3: max-with 480px, right',
               'column-padding-medium' => 'Style 4: Padding Medium',
               'column-box-shadow'     => 'Style 5: Box Shadow',
               'column-box-shadow-2'   => 'Style 6: Box Shadow & Padding',
               'column-border'         => 'Style 7: Border & Padding',
             )
          ),
		      array(
		        'id'      => 'el_class',
