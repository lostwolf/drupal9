 ...
 */
function gavias_nonid_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'gavias_nonid/gavias-nonid-admin';  
  ...
  $form['header']['default_header'] = array(
    ...
    '#options' => array(
      'header' => t('Header I'),
      'header-1' => t('Header II'),
      'header-2' => t('Header III'),
      'header-3' => t('Header IV')
    ),
  );
